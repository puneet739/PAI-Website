...
export function DashboardSidebar({ currentPath, userRole }: DashboardSidebarProps) {
  ...
  // Add admin link for admin/instructor users
  if (isAdmin) {
    navItems.push({
      path: '/admin',
      label: 'Admin Panel',
  ...
  return (
    <aside className="w-64 bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 min-h-screen">
      <div className="p-6">
