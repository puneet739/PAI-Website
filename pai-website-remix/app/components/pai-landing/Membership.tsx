    ...
    <section id="membership" className="py-12 bg-gray-50 dark:bg-gray-900/40">
      <div className="container mx-auto px-4 grid gap-6 md:grid-cols-[1.3fr,1fr] items-start">
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-5 shadow-sm bg-white dark:bg-gray-950">
          ...
          <p className="mt-3"><a className="inline-flex items-center justify-center rounded-full px-5 py-2.5 text-white bg-gradient-to-r from-sky-500 to-orange-500 shadow hover:opacity-95 transition w-full sm:w-auto" href="mailto:support@pgaoi.org">support@pgaoi.org</a></p>
        </div>
      </div>
    </section>
  );
