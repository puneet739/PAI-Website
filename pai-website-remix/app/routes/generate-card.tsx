...
export default function GenerateCard({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      <DashboardSidebar currentPath="/generate-card" userRole={member.membership_type} />
      ...
      <div className="flex-1 lg:ml-0">
        ...
        <main className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="mb-6 flex flex-wrap gap-4 print:hidden">
            ...
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900 transition font-medium"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
